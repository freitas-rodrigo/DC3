...
for perplexity in perplexity_list:
  ...
  # Plot.
  color = cm(yT/max(yT))
  ax.scatter(X[2:,0], X[2:,1], marker='^', alpha=0.3, color=color, lw=0, s=40)
  ax.plot(X[0,0], X[0,1], 'C3o', zorder=100, markersize=9)
  ax.plot(X[1,0], X[1,1], 'C3o', zorder=100, markersize=9)
  ...
  # Save figure.
  fig.savefig("figures/fig_tSNE_temperature_dependence_perplexity_%d.png" % perplexity, dpi=400)
  plt.close()
