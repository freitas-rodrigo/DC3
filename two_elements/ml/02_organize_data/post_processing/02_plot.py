...
# Save figure.
fig.savefig("figures/fig_alpha_histogram.png", dpi=400)
fig.savefig("figures/fig_alpha_histogram_binary.pdf")
plt.close()
...
# Save figure.
fig.savefig("figures/fig_alpha_cummulative_distribution.png", dpi=400)
fig.savefig("figures/fig_alpha_cummulative_distribution_binary.pdf")
plt.close()
